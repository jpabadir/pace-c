...
6. Follow the prompts to complete your registration. You need to complete your registration via automatically sent validation email.
...
12. Try to log out again and try to reset your password using 'forgot password' link in Sign in page. You need to check comfirmation email to complete your reset. Then, use your new password to log in.
13. Finish
## Tasks of mentee
Consider youself as **a mentee** in the system.
1. Click on Mentee form understand what content should be fill in these fields.
2. Leave some required fields blank and fill out others and try to submit.
3. Click on each buttons except 'Submit' button and check whether their functionalities work as you expect.
4. Leave some unrequired fields blank and fill out the required and try to submit.
5. Finish
## Tasks of Admins
